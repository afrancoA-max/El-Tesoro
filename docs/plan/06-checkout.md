...
- Creación de la orden con número correlativo legible (ej. `AET-2026-00001`), estado inicial `pending_payment`, snapshot de precios y productos (la orden no cambia si el catálogo cambia después), y **reserva de stock con expiración** según la skill de carrito (sección 7).
